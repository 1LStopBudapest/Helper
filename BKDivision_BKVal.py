...
if ftype=='JEC':
    hname = ['h_reg', 'h_JECUp', 'h_JECDown', 'h_JERUp', 'h_JERDown'] #for JEC unc root files
else:
    hname = ['h_reg', 'h_PU', 'h_PUUp', 'h_PUDown', 'h_WPt', 'h_WPtUp', 'h_WPtDown', 'h_LeptonSF', 'h_LeptonSFUp', 'h_LeptonSFDown', 'h_BTagSF', 'h_BTagSFbUp', 'h_BTagSFbDown', 'h_BTagSFlUp', 'h_BTagSFlDown', 'h_XsecUp'] #these histos should present in the root files
